...
<link rel="stylesheet" href="css/template_css.css" type="text/css"/><link rel="shortcut icon" href="images/favicon.jpg" />
	...
	<tr class='TRHeader'>
	  <td colspan="2"><b>COURT INFORMATION</b></td></tr>
	 <tr>
	 ...
	 <tr>
        ...
        <td><input type="text" name="location" size="20" maxlength="60" class="memorize" value ="<?php echo "".value("location").""; ?>"/></td><td><?php echo "". error("location").""; ?> </td></tr>
...
$query = "INSERT INTO court_tbl(court name,court location) VALUES ('$name','$location')";
echo $query;
$result = mysql_query($query);
if ($result){
  echo "The Court details were entered into the database";
}
