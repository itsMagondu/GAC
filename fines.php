...
$field = "fine";
if (!$fine || strlen($fine = trim($fine)) == 0) {
    $errmsg = "*Enter the fine";
    setError($field, $errmsg);
}
...
if ($num_errors > 0) {
    ...
    <div id="page">
        <div id="page-bgtop">
                                       ...
                                       // var_dump($errors);
                                        ...
                                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>"method="POST" enctype="multipart/form-data"  style="background-color:#CCC">
                                            ...
                                            <table width="70%" border="0" cellspacing="10" cellpadding="2" align="center" >
                                                <tr class='TRHeader'>
                                                  <td colspan="2"><b>FINE INFORMATION</b></td></tr>
                                                <tr>
                                                    <td width="25%"><b>Fine charged*</b></td>
                                                    <td><textarea cols="45" rows="5" name="fine" class="memorize" value ="<?php echo "" . value("fine") . ""; ?>" ></textarea></td><td><?php echo "" . error("fine") . ""; ?> </td></tr>
			...
			{
                 $query = "INSERT INTO fines_tbl(fine charged) VALUES ('$fine')";
                                        //echo $query;
                                        $result = mysql_query($query);
                                      if ($result) {
                                     echo "              The Fine details were entered into the database";
                                     }
                            }
            include("footer.php");
  ?> 